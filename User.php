<?php
//Simpanlah dengan nama file : User.php
...
class User 
{
    ...
    public function get_by_kodemk(string $username)
    {
    ...
    public function update_by_kodemk(string $username): int
    {
        $query = "UPDATE $this->table SET username = '$this->username', passwd = '$this->passwd', rolename = '$this->rolename' 
    ...
    public function delete_by_kodemk(string $username): int
    {
